...
public class homePage extends pageBaseClass{
	...
	//	locElement.sendKeys(cityName);
		...
		//Highlighting the value
  		...
  		js.executeScript("arguments[0].setAttribute('style', 'background: yellow; border: 2px solid red;');", locElement);
 	...
 	//	locElement.sendKeys(cityName);
        ...
        WebElement hospitalType =  driver.findElement(By.xpath(prop.getProperty("hospitalSearchBox_xpath")));
  		...
  		//JavascriptExecutor js1 = (JavascriptExecutor) driver;
  	     // pass values based on css style. Yellow background color with solid red color border. 
  		js.executeScript("arguments[0].setAttribute('style', 'background: yellow; border: 2px solid red;');", hospitalType);
